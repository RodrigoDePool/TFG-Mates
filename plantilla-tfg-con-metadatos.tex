...
La figura [AGREGAR REFERENCIA] ilustra varios casos distintos de superficies no compactas: La imagen (a) muestra una superficie planar; la imagen (b) muestra una superficie de género infinito orientable; la imagen (c) corresponde a una superficie de género finito, finitamente no orientable; y el (d) corresponde con una superficie infinitamente no orientable. 
...
Queda ahora probar que la $S$ que se obtiene tiene un borde ideal equivalente a la terna $(X,Y,Z)$. (TODO: terminar).
