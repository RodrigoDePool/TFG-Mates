...
\begin{defin}
	...
	\begin{enumerate}
		\item 
		Para cada $S_i$ tomamos un subconjunto $D_i\subset S_i$ homeomorfo a un disco cerrado de dos dimensiones $E^2$. Llamamos $S'_i$ al complementario del interior de $D_i$.
		\item 
	...
	\end{enumerate}
	Para confirmar la validez de estar definición hay que aclarar varios puntos. Primero, por qué podemos asegurar en el punto 1 que existe un subconjunto homeomorfo a un disco. Segundo, tenemos que asegurarnos que en el punto dos las fronteras de $D_1$ y $D_2$ tienen la misma imagen. Tercero, habría que comprobar que, en efecto, el objeto obtenido es una superficie. Y, finalmente, tenemos que comprobar que esta definición es independiente de los conjuntos $D_i$ escogidos e independiente de los homeomorfismos. (FALTA PROBAR CADA UNO DE ESTOS PUNTOS)
\end{defin}
